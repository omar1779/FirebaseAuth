...
function Form({ nameForm }) {
  ...
  return (
    <div className="flex w-4/6 bg-slate-400 rounded-xl shadow-2xl items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div>
            <button
              ...
              } mb-3 flex w-full justify-center rounded-md border border-transparent  py-2 px-4 text-sm font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2`}
            >
              {nameForm}
            </button>
            <div
